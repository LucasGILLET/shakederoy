    ...
    if (!authLoading && user) {
        return (
            <div className="min-h-[calc(100vh-80px)] flex items-center justify-center p-4">
                <div className="w-full max-w-md card-skew !p-10 bg-gradient-to-br from-white to-pink-50 text-center">
                    <div className="transform skewY(2deg)">
                        <h1 className="text-4xl font-display mb-4">Session deja active</h1>
            ...
            <div className={`w-full max-w-md card-skew !p-10 bg-gradient-to-br from-white to-pink-50 ${mounted ? 'animate-bounce-in' : 'opacity-0'}`}>
                <div className="transform skewY(2deg)">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600 text-lg">Connecte-toi pour continuer.</p>
                    </div>
