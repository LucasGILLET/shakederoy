...
export const MOCK_COCKTAILS: Cocktail[] = [
    ...
    { id: '4', name: 'Cosmopolitan', tags: ['Acidulé', 'Vodka', 'Soirée'], difficulty: 'Moyen', duration: '5 min', alcohol: true, description: "Le cocktail iconique de New York. Rose, élégant et parfaitement équilibré.", color: '#f472b6', ingredients: [], steps: [] },
    { id: '5', name: 'Bora Bora', tags: ['Fruité', 'Exotique'], difficulty: 'Facile', duration: '4 min', alcohol: false, description: "Un voyage instantané dans les îles sans quitter votre salon.", color: '#f87171', ingredients: [], steps: [] },
    { id: '6', name: 'Espresso Martini', tags: ['Café', 'Énergisant'], difficulty: 'Difficile', duration: '10 min', alcohol: true, description: "Le coup de boost parfait pour commencer (ou finir) la soirée.", color: '#78350f', ingredients: [], steps: [] },
    { id: '7', name: 'Spritz', tags: ['Amer', 'Frais', 'Pétillant'], difficulty: 'Facile', duration: '2 min', alcohol: true, description: "L'apéritif italien par excellence.", color: '#fb923c', ingredients: [], steps: [] },
    { id: '8', name: 'Limonade Maison', tags: ['Citron', 'Bio', 'Frais'], difficulty: 'Facile', duration: '10 min', alcohol: false, description: "Rien ne vaut une limonade fraîche faite avec amour.", color: '#facc15', ingredients: [], steps: [] },
];
